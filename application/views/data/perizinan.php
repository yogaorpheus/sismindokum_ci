        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              {
                ?>
                <a href="<?php echo base_url('data/perizinan/download');?>">
        ...
        <div class="modal modal-primary fade" id="modal_download">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a id="download_btn" href="<?php echo base_url('data/perizinan/download'); ?>"><button type="button" class="btn btn-success pull-left">Unduh Data</button></a>
    ...
    <script>
      ...
      $(function () {
        ...
        $("#distrik_download").change(function() {
          ...
          if (kode_distrik == '0')
            kode_distrik = "";
          $("#download_btn").attr('href', "<?php echo base_url('data/perizinan/download')."/"; ?>"+kode_distrik);
        })
