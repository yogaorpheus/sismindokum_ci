        ...
        <div class="modal modal-primary fade" id="modal_download">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a id="download_btn" href="<?php echo base_url('data/slo/download'); ?>"><button type="button" class="btn btn-success pull-left">Unduh Data</button></a>
    ...
    <script>
      ...
      $(function () {
        ...
        $("#distrik_download").change(function() {
          ...
          if (kode_distrik == '0')
            kode_distrik = "";
          $("#download_btn").attr('href', "<?php echo base_url('data/slo/download')."/"; ?>"+kode_distrik);
        })
