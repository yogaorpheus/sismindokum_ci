    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <form id="form_sertifikat_perizinan" action="<?php echo base_url('unitcontroller/update_unit'); ?>" method="POST">
            <div class="box box-primary">
              <div class="box-header with-border">
                <input type="hidden" name="id" value="<?php echo $data_unit['id_unit']; ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="nama" type="text" value="<?php echo $data_unit['nama_unit']; ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%" name="distrik">
                        ...
                        foreach ($data_distrik as $key => $one_distrik) {
                          if ($one_distrik['id_distrik'] == $data_unit['id_distrik'])
