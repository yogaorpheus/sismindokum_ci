    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <form id="form_sertifikat_perizinan" action="<?php echo base_url('sertifikat_data/tambah_perizinan'); ?>" method="POST" enctype="multipart/form-data">
...
<script>
  $(function () {
    ...
    {
      ?>alert('Data Perizinan berhasil dimasukkan'); <?php
    }
    else if ($this->session->flashdata('error') == 2)
    {
      ?>alert('Data Perizinan gagal dimasukkan'); <?php
    }
    ?>
