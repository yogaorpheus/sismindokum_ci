                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" autocomplete="off" id="datepicker1" name="tanggal_terbit" value="<?php echo $data_perizinan['tanggal_terbit']; ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" autocomplete="off" id="datepicker2" name="tanggal_berakhir" value="<?php echo $data_perizinan['tanggal_berakhir']; ?>" required>
                      </div>
                    </div>
