                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="keterangan" placeholder="Tuliskan keterangan sertifikat" rows="4" value="<?php echo $data_pertanahan['keterangan']; ?>"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block"><?php echo $data_pertanahan['file_sertifikat']; ?></p>
                    </div>
