    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Pertanahan</li>
        <li class="active">Edit Pertanahan</li>
      </ol>
    </section>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;" name="jenis_pertanahan" required>
                        <?php
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="no_sertifikat" name="no_sertifikat" value="<?php echo $data_pertanahan['no_sertifikat']; ?>" required>
                    </div>

                    <div class="form-group">
                      <label>Lokasi Sertifikat</label>
                      <input type="text" class="form-control" id="lokasi_sertifikat" name="lokasi_sertifikat" value="<?php echo $data_pertanahan['judul_sertifikat']; ?>" required>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" autocomplete="off" id="datepicker1" name="tanggal_terbit" value="<?php echo $data_pertanahan['tanggal_terbit']; ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" autocomplete="off" id="datepicker2" name="tanggal_berakhir" value="<?php echo $data_pertanahan['tanggal_berakhir']; ?>" required>
                      </div>
                    </div>
