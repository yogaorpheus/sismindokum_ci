              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Referensi Pengujian</label>
                      <select class="form-control select2" style="width: 100%;" name="referensi_pengujian" id="referensi">
                        <?php
                        foreach ($dasar_hukum as $key => $one_dasar_hukum) {
                          if ($one_dasar_hukum['id_dasar_hukum'] == $data_pengujian['id_dasar_hukum_sertifikat'])
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="no_sertifikat" name="no_sertifikat" value="<?php echo $data_pengujian['no_sertifikat']; ?>">
                    </div>

                    <div class="form-group">
                      <label>Peralatan / Lokasi</label>
                      <input type="text" class="form-control" id="peralatan" name="peralatan" value="<?php echo $data_pengujian['judul_sertifikat']; ?>">
                    </div>

                    <div class="form-group">
                      <label>Jenis Pengujian</label>
                      <select class="form-control select2" style="width: 100%;" name="jenis_pengujian">
                        <?php
                        foreach ($sub_jenis_sertifikat as $key => $one_sub_jenis) {
                          if ($one_sub_jenis['id_sub_jenis_sertifikat'] == $data_pengujian['id_sub_jenis_sertifikat'])
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="keterangan" placeholder="Tuliskan keterangan sertifikat" rows="4" value="<?php echo $data_pengujian['keterangan']; ?>"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker1" name="tanggal_terbit" value="<?php echo $data_pengujian['tanggal_terbit']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker2" name="tanggal_berakhir" value="<?php echo $data_pengujian['tanggal_berakhir']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block"><?php echo $data_pengujian['file_sertifikat']; ?></p>
                    </div>
                  </div>
